...
public class rv_adapter_deliverable extends RecyclerView.Adapter<holder_del> {
    ...
    public rv_adapter_deliverable(int[] img1, String[] food, String[] restaurant, String[] price, String[] location, Context context) {
        this.img1 = img1;
        this.food = food;
